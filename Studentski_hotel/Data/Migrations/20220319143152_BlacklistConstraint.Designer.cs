...
namespace DBdata.Migrations
{
    ...
    [Migration("20220319143152_BlacklistConstraint")]
    partial class BlacklistConstraint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBdata.EntityModels.Artikal", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DBdata.EntityModels.ArtikalCijena", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ArtikalCijenas");
                });

            modelBuilder.Entity("DBdata.EntityModels.ArtikalObrok", b =>
                {
                    b.Property<int>("ArtikalID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ArtikalID", "ObrokID");

                    b.HasIndex("ObrokID");

                    b.ToTable("ArtikalObroks");
                });

            modelBuilder.Entity("DBdata.EntityModels.BlackList", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DBdata.EntityModels.Student", b =>
                {
                    ...
                    b.Property<string>("RazlogZaBlackListu")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DBdata.EntityModels.Ugovor", b =>
                {
                    ...
                    b.Property<string>("DatumIseljenja")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DatumUseljenja")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DBdata.EntityModels.ArtikalCijena", b =>
                {
                    b.HasOne("DBdata.EntityModels.Artikal", "Artikal")
                        .WithMany()
            ...
            modelBuilder.Entity("DBdata.EntityModels.ArtikalObrok", b =>
                {
                    b.HasOne("DBdata.EntityModels.Artikal", "Artikal")
                        .WithMany("ArtikalObroks")
                        .HasForeignKey("ArtikalID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DBdata.EntityModels.Obrok", "Obrok")
                        .WithMany("ArtikalObroks")
            ...
            modelBuilder.Entity("DBdata.EntityModels.Student", b =>
                {
                    b.HasOne("DBdata.EntityModels.BlackList", "BlackList")
                        .WithMany()
